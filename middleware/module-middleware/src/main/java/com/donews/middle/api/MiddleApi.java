...
public class MiddleApi {
    ...
    public final static String commandUrl = BuildConfig.BASE_CONFIG_URL  + com.donews.common.BuildConfig.APP_IDENTIFICATION+"-"+"cmdConfig" + BuildConfig.BASE_RULE_URL;
