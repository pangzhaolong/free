...
public class RoundCornersTransform extends BitmapTransformation {
     ...
     * @param bl 左下
     */
    public RoundCornersTransform(float tl, float tr, float br, float bl) {
        this.radius[0] = tl;
        this.radius[1] = tr;
        this.radius[2] = br;
        this.radius[3] = bl;
    ...
    public boolean equals(Object o) {
        if (o instanceof RoundCornersTransform) {
            return Arrays.equals(this.radius, ((RoundCornersTransform) o).radius);
        }
        return false;
    }
