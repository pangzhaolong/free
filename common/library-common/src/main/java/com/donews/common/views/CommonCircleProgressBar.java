...
public class CommonCircleProgressBar extends View {
    ...
    public CommonCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typeArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CommonCircleProgressBar, 0, 0);
        radius = typeArray.getDimension(R.styleable.CommonCircleProgressBar_common_radius, 70);
        strokeWidth = typeArray.getDimension(R.styleable.CommonCircleProgressBar_common_strokeWidth, 6);
        ringColor = typeArray.getColor(R.styleable.CommonCircleProgressBar_common_ringColor, 0xFF4800);
        strokeBgColor = typeArray.getColor(R.styleable.CommonCircleProgressBar_common_strokeBgColor, Color.GRAY);
        currentProgress = typeArray.getInteger(R.styleable.CommonCircleProgressBar_common_progress, 0);
    }
...
//        }
        ...
        mRingPaintBg.setStrokeWidth(strokeWidth);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            //画阴影
...
//        }
    ...
    @BindingAdapter(value = {"common_progress"})
    public void setCurrentProgress(CommonCircleProgressBar currentProgressBar  ,int currentProgress) {
