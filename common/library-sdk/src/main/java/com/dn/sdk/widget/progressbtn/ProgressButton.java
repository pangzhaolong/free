...
public class ProgressButton extends androidx.appcompat.widget.AppCompatTextView {
    ...
    //覆盖后颜色
    private int mTextCoverColor = Color.BLACK;
    //文字大小
    ...
    //记录当前文字
    private CharSequence mCurrentText = "立即下载";
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mAboveTextSize = a.getFloat(R.styleable.ProgressButton_progressbtn_text_size, 50);
        mTextColor = a.getColor(R.styleable.ProgressButton_progressbtn_text_color, Color.BLACK);
        mTextCoverColor = a.getColor(R.styleable.ProgressButton_progressbtn_text_covercolor, Color.BLACK);
    ...
    private void drawBackground(Canvas canvas) {
        ...
        mBackgroundBounds.left = 4;
        mBackgroundBounds.top = 4;
        mBackgroundBounds.right = getMeasuredWidth() - 4;
        mBackgroundBounds.bottom = getMeasuredHeight() - 4;
        ...
        switch (mState) {
            case NORMAL:
                if (buttonController.enableGradient()) {
                    ...
                    int mdth = getMeasuredWidth();
                    mProgressBgGradient = new LinearGradient(0, 0, mdth, 0,
                            new int[]{mBackgroundColor[0], mBackgroundSecondColor},
                            new float[]{0, 0 + 0.001f},
                            Shader.TileMode.CLAMP
                    );
            ...
            case DOWNLOADING:
                if (buttonController.enableGradient()) {
                    ...
                    mProgressBgGradient = new LinearGradient(0, 0, measurewidth, 0,
                            new int[]{mBackgroundColor[0], mBackgroundSecondColor},
    ...
    public String getCurrentText() {
        return !TextUtils.isEmpty(mCurrentText)?mCurrentText.toString():"";
    }
