 ...
 * @since v1.0
 */
public class ActivityLifecycleV28_V30 implements IActivityLifecycleCrashHandler {
    ...
    //private IBinder mToken ; finishTask = DONT_FINISH_TASK_WITH_ACTIVITY = 0
    ...
    private void finish(IBinder binder) throws Exception {
        //https://www.androidos.net.cn/android/10.0.0_r6/tree     frameworks/base/core/java/android/app/ActivityManager 搜索IActivityManagerSingleton
