...
public class Item2Fragment extends MvvmLazyLiveDataFragment<Item1FragmentBinding, Item1FragmentViewModel> {
    ...
    private  void setObserveList(){
        mViewModel.getMutableLiveData().observe(Item2Fragment.this.getActivity(), RaidersBean->{
