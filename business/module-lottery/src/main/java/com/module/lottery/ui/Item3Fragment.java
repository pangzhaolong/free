...
public class Item3Fragment extends MvvmLazyLiveDataFragment<Item1FragmentBinding, Item1FragmentViewModel> {
    ...
    private  void setObserveList(){
        mViewModel.getMutableLiveData().observe(Item3Fragment.this.getActivity(), RaidersBean->{
