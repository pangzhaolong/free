...
public class Item1Fragment extends MvvmLazyLiveDataFragment<Item1FragmentBinding, Item1FragmentViewModel> {
    ...
    private  void setObserveList(){
        mViewModel.getMutableLiveData().observe(Item1Fragment.this.getActivity(), RaidersBean->{
