...
/*        addDisposable(EasyHttp.post(HomeApi.TopBannerUrl)
//                .upJson("")
                .cacheMode(CacheMode.NO_CACHE)
                .execute(new SimpleCallBack<TopBannerBean>() {
                    ...
                    @Override
                    public void onSuccess(TopBannerBean topBannerBean) {
                        mutableLiveData.postValue(topBannerBean);
                    }
                }));
